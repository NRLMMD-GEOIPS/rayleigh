...
librayleigh.so: rayleigh.f90 process_color.o config.o string_operations.o rayleigh_constants.o modis_rayleigh_constants.o viirs_rayleigh_constants.o himawari8_ahi_rayleigh_constants.o geokompsat_ami_rayleigh_constants.o meteosat12_fci_rayleigh_constants.o goes16_abi_rayleigh_constants.o goes17_abi_rayleigh_constants.o rayleigh_chan_constants.o config.o prettyprint.o
#SWITCH BACK AFTER FIGURING OUT "USE" IN F2PY
librayleigh_constants.so: rayleigh_constants.f90 config.o string_operations.o modis_rayleigh_constants.o viirs_rayleigh_constants.o himawari8_ahi_rayleigh_constants.o geokompsat_ami_rayleigh_constants.o meteosat12_fci_rayleigh_constants.o goes16_abi_rayleigh_constants.o goes17_abi_rayleigh_constants.o rayleigh_chan_constants.o
...
#SWITCH BACK AFTER FIGURING OUT "USE" IN F2PY
rayleigh_constants.o: rayleigh_constants.f90 string_operations.mod modis_rayleigh_constants.mod viirs_rayleigh_constants.mod himawari8_ahi_rayleigh_constants.mod geokompsat_ami_rayleigh_constants.mod meteosat12_fci_rayleigh_constants.mod goes16_abi_rayleigh_constants.mod goes17_abi_rayleigh_constants.mod config.o
...
geokompsat_ami_rayleigh_constants.o: geokompsat_ami_rayleigh_constants.f90 rayleigh_chan_constants.mod
meteosat12_fci_rayleigh_constants.o: meteosat12_fci_rayleigh_constants.f90 rayleigh_chan_constants.mod
